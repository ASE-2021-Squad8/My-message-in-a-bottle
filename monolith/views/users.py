...
def change_data_user():
    ...
    if request.method == 'POST':
        ...
        if(user.firstname == "" or user.lastname=="" or user.email=="" or user.dateofbirth == ""):
            return render_template('edit_profile.html', form=form, user=current_user, error = "All fields must be completed!")
